      ...
      <section aria-labelledby="about" className={style.section}>
        <div>
          ...
          <p>
            ...
            thousands lines of code and a growing knowledge built day by day. In
            the last 17 years I've been working for H-art and AKQA in Venice
            headquarter, Italy.
          </p>
            ...
            >
              <div>
                ...
                <p>
                  ...
                  (Fractal/Storybook) but I also create landing pages or static
                  sites with a &ldquo;mobile-first&rdquo; approach. I do love
                  CSS and I like creating inspiring demos on Codepen. Sometimes
                  I get involved by participating in coding contests such as the{" "}
                  <a
                ...
                <p>
                  One year ago I started to explore ReactJS/NextJS studying many
                  courses (Udemy/FrontendMasters) and trying to integrate these
                  frameworks with Next-Auth, GraphQL, MongoDB, Contentful, AWS
                  and Vercel.
                </p>
              </div>
            ...
            >
              <div>
                ...
                <p>
                  ...
                  adjustments to remove or limit the main accessibility issues.
                </p>
              </div>
